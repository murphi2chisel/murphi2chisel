...
when(io.en_r){
when(((io.Sta_in.UniMsg(src).Cmd===UNI_GetX)&&(io.Sta_in.UniMsg(src).HomeProc&&((!io.Sta_in.Dir.Pending)&&((!io.Sta_in.Dir.Dirty)&&((io.Sta_in.Dir.HeadPtr===src.U)&&((!io.Sta_in.Dir.HomeHeadPtr)&&((!io.Sta_in.Dir.HomeShrSet)&&(List.range(1, NODE_NUM).forall(p => bool2boolean((!(p.U=/=src.U)||(!io.Sta_in.Dir.ShrSet(p))))).B&&(io.Sta_in.Dir.Local&&(io.Sta_in.HomeProc.ProcCmd===NODE_Get))))))))))){
io.Sta_out.Dir.Local := false.B
io.Sta_out.Dir.Dirty := true.B
io.Sta_out.Dir.HeadVld := true.B
io.Sta_out.Dir.HeadPtr := src.U
...
when(io.en_r){
when(((io.Sta_in.UniMsg(src).Cmd===UNI_GetX)&&(io.Sta_in.UniMsg(src).HomeProc&&((!io.Sta_in.Dir.Pending)&&((!io.Sta_in.Dir.Dirty)&&((io.Sta_in.Dir.HeadPtr===src.U)&&((!io.Sta_in.Dir.HomeHeadPtr)&&((!io.Sta_in.Dir.HomeShrSet)&&(List.range(1, NODE_NUM).forall(p => bool2boolean((!(p.U=/=src.U)||(!io.Sta_in.Dir.ShrSet(p))))).B&&(!io.Sta_in.Dir.Local)))))))))){
io.Sta_out.Dir.Local := false.B
io.Sta_out.Dir.Dirty := true.B
io.Sta_out.Dir.HeadVld := true.B
io.Sta_out.Dir.HeadPtr := src.U
...
when(io.en_r){
when(((io.Sta_in.InvMsg(src).Cmd===INV_InvAck)&&(io.Sta_in.Dir.Pending&&(io.Sta_in.Dir.InvSet(src)&&(io.Sta_in.Dir.Local&&((!io.Sta_in.Dir.Dirty)&&((!io.Sta_in.Dir.HomeInvSet)&&List.range(1, NODE_NUM).forall(p => bool2boolean(((p.U===src.U)||(!io.Sta_in.Dir.InvSet(p))))).B))))))){
io.Sta_out.InvMsg(src).Cmd := INV_None
io.Sta_out.Dir.InvSet(src) := false.B
io.Sta_out.Dir.Pending := false.B
io.Sta_out.Dir.Local := false.B
...
when(io.en_r){
when(((io.Sta_in.InvMsg(src).Cmd===INV_InvAck)&&(io.Sta_in.Dir.Pending&&(io.Sta_in.Dir.InvSet(src)&&((!io.Sta_in.Dir.Local)&&((!io.Sta_in.Dir.HomeInvSet)&&List.range(1, NODE_NUM).forall(p => bool2boolean(((p.U===src.U)||(!io.Sta_in.Dir.InvSet(p))))).B)))))){
io.Sta_out.InvMsg(src).Cmd := INV_None
io.Sta_out.Dir.InvSet(src) := false.B
io.Sta_out.Dir.Pending := false.B
}
...
when(io.en_r){
when(((io.Sta_in.InvMsg(src).Cmd===INV_InvAck)&&(io.Sta_in.Dir.Pending&&(io.Sta_in.Dir.InvSet(src)&&(io.Sta_in.Dir.Dirty&&((!io.Sta_in.Dir.HomeInvSet)&&List.range(1, NODE_NUM).forall(p => bool2boolean(((p.U===src.U)||(!io.Sta_in.Dir.InvSet(p))))).B)))))){
io.Sta_out.InvMsg(src).Cmd := INV_None
io.Sta_out.Dir.InvSet(src) := false.B
io.Sta_out.Dir.Pending := false.B
}
