...
assert((!((Sta_reg.HomeProc.CacheData===2.U)&&((Sta_reg.Dir.Pending===true.B)&&((Sta_reg.Dir.Local===false.B)&&((Sta_reg.Dir.Dirty===true.B)&&((Sta_reg.Dir.HeadVld===true.B)&&((Sta_reg.Dir.HeadPtr===2.U)&&((Sta_reg.Dir.HomeHeadPtr===false.B)&&((Sta_reg.Dir.ShrVld===false.B)&&((Sta_reg.Dir.ShrSet(1)===false.B)&&((Sta_reg.Dir.ShrSet(2)===false.B)&&((Sta_reg.Dir.HomeShrSet===false.B)&&((Sta_reg.Dir.InvSet(1)===false.B)&&((Sta_reg.Dir.InvSet(2)===false.B)&&((Sta_reg.Dir.HomeInvSet===false.B)&&((Sta_reg.MemData===2.U)&&((Sta_reg.UniMsg(1).Cmd===UNI_None)&&((Sta_reg.UniMsg(1).Proc===2.U)&&((Sta_reg.UniMsg(1).HomeProc===true.B)&&((Sta_reg.UniMsg(1).Data===2.U)&&((Sta_reg.UniMsg(2).Cmd===UNI_PutX)&&((Sta_reg.UniMsg(2).Proc===1.U)&&((Sta_reg.UniMsg(2).HomeProc===false.B)&&((Sta_reg.UniMsg(2).Data===1.U)&&((Sta_reg.HomeUniMsg.Cmd===UNI_Nak)&&((Sta_reg.HomeUniMsg.Proc===2.U)&&((Sta_reg.HomeUniMsg.HomeProc===false.B)&&((Sta_reg.HomeUniMsg.Data===2.U)&&((Sta_reg.InvMsg(1).Cmd===INV_None)&&((Sta_reg.InvMsg(2).Cmd===INV_None)&&((Sta_reg.HomeInvMsg.Cmd===INV_None)&&((Sta_reg.RpMsg(1).Cmd===RP_None)&&((Sta_reg.RpMsg(2).Cmd===RP_None)&&((Sta_reg.HomeRpMsg.Cmd===RP_None)&&((Sta_reg.WbMsg.Cmd===WB_None)&&((Sta_reg.WbMsg.Proc===2.U)&&((Sta_reg.WbMsg.HomeProc===false.B)&&((Sta_reg.WbMsg.Data===1.U)&&((Sta_reg.ShWbMsg.Cmd===SHWB_None)&&((Sta_reg.ShWbMsg.Proc===2.U)&&((Sta_reg.ShWbMsg.HomeProc===false.B)&&((Sta_reg.ShWbMsg.Data===2.U)&&((Sta_reg.NakcMsg.Cmd===NAKC_Nakc)&&(Sta_reg.CurrData===1.U)))))))))))))))))))))))))))))))))))))))))))))
}