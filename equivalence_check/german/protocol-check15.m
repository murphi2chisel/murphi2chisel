...
!(Cache[1].State = E&Cache[1].Data = 2&Cache[2].State = I&Cache[2].Data = 1&Chan1[1].Cmd = ReqS&Chan1[1].Data = 1&Chan1[2].Cmd = Empty&Chan1[2].Data = 1&Chan2[1].Cmd = Inv&Chan2[1].Data = 2&Chan2[2].Cmd = Empty&Chan2[2].Data = 2&Chan3[1].Cmd = Empty&Chan3[1].Data = 2&Chan3[2].Cmd = Empty&Chan3[2].Data = 1&InvSet[1] = false&InvSet[2] = false&ShrSet[1] = true&ShrSet[2] = false&ExGntd = false&CurCmd = ReqE&CurPtr = 1&MemData = 2&AuxData = 1)