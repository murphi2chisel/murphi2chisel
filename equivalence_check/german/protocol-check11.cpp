...
bool mu__boolexpr67;
bool mu__boolexpr68;
  if (!((mu_Cache[1].mu_State) == (mu_I))) mu__boolexpr68 = FALSE ;
  else {
  ...
  mu__boolexpr65 = ((mu_Chan1[1].mu_Cmd) == (mu_Empty)) ; 
}
  ...
  mu__boolexpr63 = ((mu_Chan1[2].mu_Cmd) == (mu_ReqS)) ; 
}
  ...
  mu__boolexpr61 = ((mu_Chan2[1].mu_Cmd) == (mu_GntE)) ; 
}
