/******************************
  Program "protocol-check17.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "protocol-check17"
...
bool mu__boolexpr68;
  ...
  mu__boolexpr61 = ((mu_Chan2[1].mu_Cmd) == (mu_Inv)) ; 
}
  ...
  mu__boolexpr53 = ((mu_InvSet[1]) == (mu_false)) ; 
}
