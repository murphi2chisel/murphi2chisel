/******************************
  Program "protocol-check2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "protocol-check2"
...
class mu_1_chanType0: public mu__byte
{
 public:
  inline int operator=(int val) { return mu__byte::operator=(val); };
  inline int operator=(const mu_1_chanType0& val) { return mu__byte::operator=((int) val); };
  mu_1_chanType0 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
  mu_1_chanType0 (void): mu__byte(0, 5, 3) {};
  mu_1_chanType0 (int val): mu__byte(0, 5, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** end of subrange decl ***/
mu_1_chanType0 mu_1_chanType0_undefined_var;
...
class mu_1_nodeId0: public mu__byte
{
 public:
  inline int operator=(int val) { return mu__byte::operator=(val); };
  inline int operator=(const mu_1_nodeId0& val) { return mu__byte::operator=((int) val); };
  mu_1_nodeId0 (const char *name, int os): mu__byte(0, 3, 3, name, os) {};
  mu_1_nodeId0 (void): mu__byte(0, 3, 3) {};
  mu_1_nodeId0 (int val): mu__byte(0, 3, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** end of subrange decl ***/
mu_1_nodeId0 mu_1_nodeId0_undefined_var;
...
class mu_1_branchType0: public mu__byte
{
 public:
  inline int operator=(int val) { return mu__byte::operator=(val); };
  inline int operator=(const mu_1_branchType0& val) { return mu__byte::operator=((int) val); };
  mu_1_branchType0 (const char *name, int os): mu__byte(0, 2, 2, name, os) {};
  mu_1_branchType0 (void): mu__byte(0, 2, 2) {};
  mu_1_branchType0 (int val): mu__byte(0, 2, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** end of subrange decl ***/
mu_1_branchType0 mu_1_branchType0_undefined_var;
...
/********************
  Invariant records
 ********************/
int mu__invariant_337() // Invariant "reachableStateN"
{
...
bool mu__boolexpr370;
  if (!((mu_Tree[1].mu_cache.mu_state) == (mu_Trunk))) mu__boolexpr370 = FALSE ;
  else {
  mu__boolexpr370 = ((mu_Tree[1].mu_father) == (1)) ; 
}
  if (!(mu__boolexpr370)) mu__boolexpr369 = FALSE ;
  else {
  mu__boolexpr369 = ((mu_Tree[1].mu_sons[1]) == (2)) ; 
}
  if (!(mu__boolexpr369)) mu__boolexpr368 = FALSE ;
  else {
  mu__boolexpr368 = ((mu_Tree[1].mu_sons[2]) == (3)) ; 
}
  if (!(mu__boolexpr368)) mu__boolexpr367 = FALSE ;
  else {
  mu__boolexpr367 = ((mu_Tree[1].mu_directory[1]) == (mu_None)) ; 
}
  if (!(mu__boolexpr367)) mu__boolexpr366 = FALSE ;
  else {
  mu__boolexpr366 = ((mu_Tree[1].mu_directory[2]) == (mu_Tip)) ; 
}
  if (!(mu__boolexpr366)) mu__boolexpr365 = FALSE ;
  else {
  mu__boolexpr365 = ((mu_Tree[1].mu_slave_pending[1]) == (mu_GrantAck)) ; 
}
  if (!(mu__boolexpr365)) mu__boolexpr364 = FALSE ;
  else {
  mu__boolexpr364 = ((mu_Tree[1].mu_slave_pending[2]) == (mu_GrantAck)) ; 
}
  if (!(mu__boolexpr364)) mu__boolexpr363 = FALSE ;
  else {
  mu__boolexpr363 = ((mu_Tree[1].mu_master_pending) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr363)) mu__boolexpr362 = FALSE ;
  else {
  mu__boolexpr362 = ((mu_Tree[1].mu_link[1][1].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr362)) mu__boolexpr361 = FALSE ;
  else {
  mu__boolexpr361 = ((mu_Tree[1].mu_link[1][1].mu_para) == (mu_NtoB)) ; 
}
  if (!(mu__boolexpr361)) mu__boolexpr360 = FALSE ;
  else {
  mu__boolexpr360 = ((mu_Tree[1].mu_link[1][2].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr360)) mu__boolexpr359 = FALSE ;
  else {
  mu__boolexpr359 = ((mu_Tree[1].mu_link[1][3].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr359)) mu__boolexpr358 = FALSE ;
  else {
  mu__boolexpr358 = ((mu_Tree[1].mu_link[1][3].mu_para) == (mu_BtoN)) ; 
}
  if (!(mu__boolexpr358)) mu__boolexpr357 = FALSE ;
  else {
  mu__boolexpr357 = ((mu_Tree[1].mu_link[1][4].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr357)) mu__boolexpr356 = FALSE ;
  else {
  mu__boolexpr356 = ((mu_Tree[1].mu_link[1][4].mu_para) == (mu_BtoT)) ; 
}
  if (!(mu__boolexpr356)) mu__boolexpr355 = FALSE ;
  else {
  mu__boolexpr355 = ((mu_Tree[1].mu_link[1][5].mu_opcode) == (mu_GrantAck)) ; 
}
  if (!(mu__boolexpr355)) mu__boolexpr354 = FALSE ;
  else {
  mu__boolexpr354 = ((mu_Tree[1].mu_link[1][5].mu_para) == (mu_BtoT)) ; 
}
  if (!(mu__boolexpr354)) mu__boolexpr353 = FALSE ;
  else {
  mu__boolexpr353 = ((mu_Tree[1].mu_link[2][1].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr353)) mu__boolexpr352 = FALSE ;
  else {
  mu__boolexpr352 = ((mu_Tree[1].mu_link[2][1].mu_para) == (mu_BtoT)) ; 
}
  if (!(mu__boolexpr352)) mu__boolexpr351 = FALSE ;
  else {
  mu__boolexpr351 = ((mu_Tree[1].mu_link[2][2].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr351)) mu__boolexpr350 = FALSE ;
  else {
  mu__boolexpr350 = ((mu_Tree[1].mu_link[2][2].mu_para) == (mu_toN)) ; 
}
  if (!(mu__boolexpr350)) mu__boolexpr349 = FALSE ;
  else {
  mu__boolexpr349 = ((mu_Tree[1].mu_link[2][3].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr349)) mu__boolexpr348 = FALSE ;
  else {
  mu__boolexpr348 = ((mu_Tree[1].mu_link[2][3].mu_para) == (mu_BtoN)) ; 
}
  if (!(mu__boolexpr348)) mu__boolexpr347 = FALSE ;
  else {
  mu__boolexpr347 = ((mu_Tree[1].mu_link[2][4].mu_opcode) == (mu_GrantData)) ; 
}
  if (!(mu__boolexpr347)) mu__boolexpr346 = FALSE ;
  else {
  mu__boolexpr346 = ((mu_Tree[1].mu_link[2][4].mu_para) == (mu_toT)) ; 
}
  if (!(mu__boolexpr346)) mu__boolexpr345 = FALSE ;
  else {
  mu__boolexpr345 = ((mu_Tree[1].mu_link[2][5].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr345)) mu__boolexpr344 = FALSE ;
  else {
  mu__boolexpr344 = ((mu_Tree[1].mu_link[2][5].mu_para) == (mu_BtoT)) ; 
}
  if (!(mu__boolexpr344)) mu__boolexpr343 = FALSE ;
  else {
  mu__boolexpr343 = ((mu_Tree[2].mu_cache.mu_state) == (mu_None)) ; 
}
  if (!(mu__boolexpr343)) mu__boolexpr342 = FALSE ;
  else {
  mu__boolexpr342 = ((mu_Tree[2].mu_father) == (1)) ; 
}
  if (!(mu__boolexpr342)) mu__boolexpr341 = FALSE ;
  else {
  mu__boolexpr341 = ((mu_Tree[2].mu_master_pending) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr341)) mu__boolexpr340 = FALSE ;
  else {
  mu__boolexpr340 = ((mu_Tree[3].mu_cache.mu_state) == (mu_None)) ; 
}
  if (!(mu__boolexpr340)) mu__boolexpr339 = FALSE ;
  else {
  mu__boolexpr339 = ((mu_Tree[3].mu_father) == (1)) ; 
}
  if (!(mu__boolexpr339)) mu__boolexpr338 = FALSE ;
  else {
  mu__boolexpr338 = ((mu_Tree[3].mu_master_pending) == (mu_Grant)) ; 
}
return !(mu__boolexpr338);
};

bool mu__condition_371() // Condition for Rule "reachableStateN"
{
...
{"reachableStateN", &mu__condition_371, NULL, },
};
...
void mu_1_chanType0::Permute(PermSet& Perm, int i) {};
void mu_1_chanType0::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_chanType0::Canonicalize(PermSet& Perm) {};
void mu_1_chanType0::SimpleLimit(PermSet& Perm) {};
void mu_1_chanType0::ArrayLimit(PermSet& Perm) {};
void mu_1_chanType0::Limit(PermSet& Perm) {};
void mu_1_chanType0::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
...
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
void mu_1_nodeId0::Permute(PermSet& Perm, int i) {};
void mu_1_nodeId0::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_nodeId0::Canonicalize(PermSet& Perm) {};
void mu_1_nodeId0::SimpleLimit(PermSet& Perm) {};
void mu_1_nodeId0::ArrayLimit(PermSet& Perm) {};
void mu_1_nodeId0::Limit(PermSet& Perm) {};
void mu_1_nodeId0::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
...
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
void mu_1_branchType0::Permute(PermSet& Perm, int i) {};
void mu_1_branchType0::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_branchType0::Canonicalize(PermSet& Perm) {};
void mu_1_branchType0::SimpleLimit(PermSet& Perm) {};
void mu_1_branchType0::ArrayLimit(PermSet& Perm) {};
void mu_1_branchType0::Limit(PermSet& Perm) {};
void mu_1_branchType0::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
