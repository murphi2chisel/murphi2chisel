...
!(Tree[1].cache.state = None&Tree[1].father = 1&Tree[1].sons[1] = 2&Tree[1].sons[2] = 3&Tree[1].directory[1] = None&Tree[1].directory[2] = None&Tree[1].slave_pending[1] = GrantAck&Tree[1].slave_pending[2] = Empty&Tree[1].master_pending = Empty&Tree[1].link[1][1].opcode = Empty&Tree[1].link[1][1].para = NtoB&Tree[1].link[1][2].opcode = Empty&Tree[1].link[1][3].opcode = Empty&Tree[1].link[1][3].para = BtoN&Tree[1].link[1][4].opcode = Empty&Tree[1].link[1][4].para = BtoT&Tree[1].link[1][5].opcode = GrantAck&Tree[1].link[1][5].para = BtoT&Tree[1].link[2][1].opcode = AcquirePerm&Tree[1].link[2][1].para = BtoT&Tree[1].link[2][2].opcode = Empty&Tree[1].link[2][2].para = toN&Tree[1].link[2][3].opcode = Empty&Tree[1].link[2][3].para = BtoN&Tree[1].link[2][4].opcode = Empty&Tree[1].link[2][4].para = toB&Tree[1].link[2][5].opcode = Empty&Tree[1].link[2][5].para = BtoT&Tree[2].cache.state = None&Tree[2].father = 1&Tree[2].master_pending = Empty&Tree[3].cache.state = None&Tree[3].father = 1&Tree[3].master_pending = Grant)