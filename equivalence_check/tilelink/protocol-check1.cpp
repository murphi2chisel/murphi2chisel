/******************************
  Program "protocol-check1.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "protocol-check1"
...
bool mu__boolexpr370;
  if (!((mu_Tree[1].mu_cache.mu_state) == (mu_Tip))) mu__boolexpr370 = FALSE ;
  else {
  ...
  mu__boolexpr366 = ((mu_Tree[1].mu_directory[2]) == (mu_None)) ; 
}
  ...
  mu__boolexpr364 = ((mu_Tree[1].mu_slave_pending[2]) == (mu_Empty)) ; 
}
  ...
  mu__boolexpr353 = ((mu_Tree[1].mu_link[2][1].mu_opcode) == (mu_AcquirePerm)) ; 
}
  ...
  mu__boolexpr347 = ((mu_Tree[1].mu_link[2][4].mu_opcode) == (mu_Empty)) ; 
}
  if (!(mu__boolexpr347)) mu__boolexpr346 = FALSE ;
  else {
  mu__boolexpr346 = ((mu_Tree[1].mu_link[2][4].mu_para) == (mu_toB)) ; 
}
