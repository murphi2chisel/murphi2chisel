/******************************
  Program "protocol-check12.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "protocol-check12"
...
bool mu__boolexpr4;
bool mu__boolexpr5;
  if (!((mu_n[1]) == (mu_C))) mu__boolexpr5 = FALSE ;
  else {
  mu__boolexpr5 = ((mu_n[2]) == (mu_C)) ; 
}
