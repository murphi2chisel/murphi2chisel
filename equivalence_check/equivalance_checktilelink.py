...
protocol_dir = '/home/czh/murphi2chisel/equivalence_check/tilelink'
constlist = [2, 3, 2, 5]
...
def checkreachablestateset():
    ...
    # sys.path.append("../equivalence_check/tilelink")
    ...
    for i in range(len(reachable_state_set)):
        ...
        os.chdir(protocol_dir)
        parser = murphi_parser("tilelink%d" % i, "%s/protocol-check%d.m" % (protocol_dir,i))
