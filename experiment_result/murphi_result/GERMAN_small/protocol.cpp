...
/*** Variable declaration ***/
mu_1__type_1 mu_Chan1("Chan1",48);

/*** Variable declaration ***/
mu_1__type_2 mu_Chan2("Chan2",96);

/*** Variable declaration ***/
mu_1__type_3 mu_Chan3("Chan3",144);

/*** Variable declaration ***/
mu_1__type_4 mu_InvSet("InvSet",192);

/*** Variable declaration ***/
mu_1__type_5 mu_ShrSet("ShrSet",216);

/*** Variable declaration ***/
mu_0_boolean mu_ExGntd("ExGntd",240);

/*** Variable declaration ***/
mu_1_MSG_CMD mu_CurCmd("CurCmd",248);

/*** Variable declaration ***/
mu_1_NODE mu_CurPtr("CurPtr",256);

/*** Variable declaration ***/
mu_1_DATA mu_MemData("MemData",264);

/*** Variable declaration ***/
mu_1_DATA mu_AuxData("AuxData",272);
...
bool Condition(unsigned r)
{
  ...
  if (r>=33 && r<=38) return R11.Condition(r-33);
...
void Code(unsigned r)
{
  ...
  if (r>=33 && r<=38) { R11.Code(r-33); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=33 && r<=38) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=33 && r<=38) return R11.Name(r-33);
  return NULL;
}
};
...
int mu__invariant_52( const mu_1_NODE &mu_j, const mu_1_NODE &mu_i) // Invariant "CntrlProp"
{
bool mu__boolexpr53;
  if (!((mu_i) != (mu_j))) mu__boolexpr53 = TRUE ;
  else {
bool mu__boolexpr54;
bool mu__boolexpr55;
  if (!((mu_Cache[mu_i].mu_State) == (mu_E))) mu__boolexpr55 = TRUE ;
  else {
  mu__boolexpr55 = ((mu_Cache[mu_j].mu_State) == (mu_I)) ; 
}
  if (!(mu__boolexpr55)) mu__boolexpr54 = FALSE ;
  else {
bool mu__boolexpr56;
  if (!((mu_Cache[mu_i].mu_State) == (mu_S))) mu__boolexpr56 = TRUE ;
  else {
bool mu__boolexpr57;
  if ((mu_Cache[mu_j].mu_State) == (mu_I)) mu__boolexpr57 = TRUE ;
  else {
  mu__boolexpr57 = ((mu_Cache[mu_j].mu_State) == (mu_S)) ; 
}
...
bool mu__condition_60() // Condition for Rule "CntrlProp, j:1, i:1"
{
  return mu__invariant_52( 1, 1 );
}

bool mu__condition_61() // Condition for Rule "CntrlProp, j:1, i:2"
{
  return mu__invariant_52( 1, 2 );
}

bool mu__condition_62() // Condition for Rule "CntrlProp, j:1, i:3"
{
  return mu__invariant_52( 1, 3 );
}

bool mu__condition_64() // Condition for Rule "CntrlProp, j:2, i:1"
{
  return mu__invariant_52( 2, 1 );
}

bool mu__condition_65() // Condition for Rule "CntrlProp, j:2, i:2"
{
  return mu__invariant_52( 2, 2 );
}

bool mu__condition_66() // Condition for Rule "CntrlProp, j:2, i:3"
{
  return mu__invariant_52( 2, 3 );
}

bool mu__condition_68() // Condition for Rule "CntrlProp, j:3, i:1"
{
  return mu__invariant_52( 3, 1 );
}

bool mu__condition_69() // Condition for Rule "CntrlProp, j:3, i:2"
{
  return mu__invariant_52( 3, 2 );
}

bool mu__condition_70() // Condition for Rule "CntrlProp, j:3, i:3"
{
  return mu__invariant_52( 3, 3 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"CntrlProp, j:3, i:3", &mu__condition_70, NULL, },
{"CntrlProp, j:3, i:2", &mu__condition_69, NULL, },
{"CntrlProp, j:3, i:1", &mu__condition_68, NULL, },
{"CntrlProp, j:2, i:3", &mu__condition_66, NULL, },
{"CntrlProp, j:2, i:2", &mu__condition_65, NULL, },
{"CntrlProp, j:2, i:1", &mu__condition_64, NULL, },
{"CntrlProp, j:1, i:3", &mu__condition_62, NULL, },
{"CntrlProp, j:1, i:2", &mu__condition_61, NULL, },
{"CntrlProp, j:1, i:1", &mu__condition_60, NULL, },
