...
class mu_1_client: public mu__byte
{
 public:
  ...
  mu_1_client (const char *name, int os): mu__byte(1, 2, 2, name, os) {};
  mu_1_client (void): mu__byte(1, 2, 2) {};
  mu_1_client (int val): mu__byte(1, 2, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
/*** Variable declaration ***/
mu_1__type_1 mu_channel2_4("channel2_4",16);

/*** Variable declaration ***/
mu_1__type_2 mu_channel3("channel3",32);

/*** Variable declaration ***/
mu_1__type_3 mu_home_sharer_list("home_sharer_list",48);

/*** Variable declaration ***/
mu_1__type_4 mu_home_invalidate_list("home_invalidate_list",64);

/*** Variable declaration ***/
mu_0_boolean mu_home_exclusive_granted("home_exclusive_granted",80);

/*** Variable declaration ***/
mu_1_message mu_home_current_command("home_current_command",88);

/*** Variable declaration ***/
mu_1_client mu_home_current_client("home_current_client",96);

/*** Variable declaration ***/
mu_1__type_5 mu_cache("cache",104);
...
bool Condition(unsigned r)
{
  ...
  if (r>=14 && r<=15) return R8.Condition(r-14);
...
void Code(unsigned r)
{
  ...
  if (r>=14 && r<=15) { R8.Code(r-14); return; } 
...
int Priority(unsigned short r)
{
  ...
  if (r>=14 && r<=15) { return R8.Priority(); } 
...
char * Name(unsigned r)
{
  ...
  if (r>=14 && r<=15) return R8.Name(r-14);
...
bool mu__condition_44() // Condition for Rule "coherent, c2:2, c1:1"
{
  return mu__invariant_36( 2, 1 );
}

bool mu__condition_45() // Condition for Rule "coherent, c2:2, c1:2"
{
...
{"coherent, c2:2, c1:2", &mu__condition_45, NULL, },
{"coherent, c2:2, c1:1", &mu__condition_44, NULL, },
