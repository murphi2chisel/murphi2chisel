...
/********************
  Invariant records
 ********************/
int mu__invariant_579() // Invariant "MemDataProp"
{
bool mu__boolexpr580;
  if (!(!(mu_Sta.mu_Dir.mu_Dirty))) mu__boolexpr580 = TRUE ;
  else {
  mu__boolexpr580 = ((mu_Sta.mu_MemData) == (mu_Sta.mu_CurrData)) ; 
}
return mu__boolexpr580;
};

bool mu__condition_581() // Condition for Rule "MemDataProp"
{
...
int mu__invariant_582() // Invariant "DataProp"
{
bool mu__quant583; 
mu__quant583 = TRUE;
{
...
bool mu__boolexpr584;
  if (!((mu_Sta.mu_Proc[mu_p].mu_CacheState) == (mu_CACHE_E))) mu__boolexpr584 = TRUE ;
  else {
  mu__boolexpr584 = ((mu_Sta.mu_Proc[mu_p].mu_CacheData) == (mu_Sta.mu_CurrData)) ; 
}
if ( !(mu__boolexpr584) )
...
bool mu__condition_585() // Condition for Rule "DataProp"
{
...
int mu__invariant_586() // Invariant "CacheStatePropHome"
{
bool mu__quant587; 
mu__quant587 = TRUE;
{
...
bool mu__boolexpr588;
  if (!((mu_Sta.mu_Proc[mu_p].mu_CacheState) == (mu_CACHE_E))) mu__boolexpr588 = FALSE ;
  else {
  mu__boolexpr588 = ((mu_Sta.mu_HomeProc.mu_CacheState) == (mu_CACHE_E)) ; 
}
if ( !(!(mu__boolexpr588)) )
...
bool mu__condition_589() // Condition for Rule "CacheStatePropHome"
{
...
int mu__invariant_590() // Invariant "CacheStateProp"
{
bool mu__quant591; 
mu__quant591 = TRUE;
{
...
mu__quant592 = TRUE;
{
for(int mu_q = 1; mu_q <= 2; mu_q++) {
bool mu__boolexpr593;
  if (!((mu_p) != (mu_q))) mu__boolexpr593 = TRUE ;
  else {
bool mu__boolexpr594;
  if (!((mu_Sta.mu_Proc[mu_p].mu_CacheState) == (mu_CACHE_E))) mu__boolexpr594 = FALSE ;
  else {
  mu__boolexpr594 = ((mu_Sta.mu_Proc[mu_q].mu_CacheState) == (mu_CACHE_E)) ; 
}
...
if ( !(mu__quant592) )
  { mu__quant591 = FALSE; break; }
};
};
return mu__quant591;
};

bool mu__condition_595() // Condition for Rule "CacheStateProp"
{
...
{"CacheStateProp", &mu__condition_595, NULL, },
{"CacheStatePropHome", &mu__condition_589, NULL, },
{"DataProp", &mu__condition_585, NULL, },
{"MemDataProp", &mu__condition_581, NULL, },
};
