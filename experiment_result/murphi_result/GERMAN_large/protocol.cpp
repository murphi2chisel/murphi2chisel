/******************************
  ...
  Murphi Last Compiled date: "Mar 22 2023"
 ******************************/
...
#define MURPHI_DATE "Mar 22 2023"
#define PROTOCOL_NAME "protocol"
#define BITS_IN_WORLD 360
#define ALIGN
#define HASHC
...
/*** Variable declaration ***/
mu_1__type_1 mu_Chan1("Chan1",64);

/*** Variable declaration ***/
mu_1__type_2 mu_Chan2("Chan2",128);

/*** Variable declaration ***/
mu_1__type_3 mu_Chan3("Chan3",192);

/*** Variable declaration ***/
mu_1__type_4 mu_InvSet("InvSet",256);

/*** Variable declaration ***/
mu_1__type_5 mu_ShrSet("ShrSet",288);

/*** Variable declaration ***/
mu_0_boolean mu_ExGntd("ExGntd",320);

/*** Variable declaration ***/
mu_1_MSG_CMD mu_CurCmd("CurCmd",328);

/*** Variable declaration ***/
mu_1_NODE mu_CurPtr("CurPtr",336);

/*** Variable declaration ***/
mu_1_DATA mu_MemData("MemData",344);

/*** Variable declaration ***/
mu_1_DATA mu_AuxData("AuxData",352);
...
bool Condition(unsigned r)
{
  ...
  if (r>=44 && r<=51) return R11.Condition(r-44);
...
void Code(unsigned r)
{
  ...
  if (r>=44 && r<=51) { R11.Code(r-44); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=44 && r<=51) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=44 && r<=51) return R11.Name(r-44);
  return NULL;
}
};
...
/********************
  Invariant records
 ********************/
int mu__invariant_44( const mu_1_NODE &mu_i) // Invariant "DataProp"
{
bool mu__boolexpr45;
bool mu__boolexpr46;
bool mu__boolexpr47;
  if (!((mu_ExGntd) == (mu_false))) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_MemData) == (mu_AuxData)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_Cache[mu_i].mu_State) != (mu_I)) ; 
}
  if (!(mu__boolexpr46)) mu__boolexpr45 = TRUE ;
  else {
  mu__boolexpr45 = ((mu_Cache[mu_i].mu_Data) == (mu_AuxData)) ; 
}
return mu__boolexpr45;
};

bool mu__condition_49() // Condition for Rule "DataProp, i:1"
{
  return mu__invariant_44( 1 );
}

bool mu__condition_50() // Condition for Rule "DataProp, i:2"
{
  return mu__invariant_44( 2 );
}

bool mu__condition_51() // Condition for Rule "DataProp, i:3"
{
  return mu__invariant_44( 3 );
}

bool mu__condition_52() // Condition for Rule "DataProp, i:4"
{
  return mu__invariant_44( 4 );
}

/**** end rule declaration ****/

int mu__invariant_53( const mu_1_NODE &mu_j, const mu_1_NODE &mu_i) // Invariant "CntrlProp"
{
bool mu__boolexpr54;
  if (!((mu_i) != (mu_j))) mu__boolexpr54 = TRUE ;
  else {
bool mu__boolexpr55;
bool mu__boolexpr56;
  if (!((mu_Cache[mu_i].mu_State) == (mu_E))) mu__boolexpr56 = TRUE ;
  else {
  mu__boolexpr56 = ((mu_Cache[mu_j].mu_State) == (mu_I)) ; 
}
  if (!(mu__boolexpr56)) mu__boolexpr55 = FALSE ;
  else {
bool mu__boolexpr57;
  if (!((mu_Cache[mu_i].mu_State) == (mu_S))) mu__boolexpr57 = TRUE ;
  else {
bool mu__boolexpr58;
  if ((mu_Cache[mu_j].mu_State) == (mu_I)) mu__boolexpr58 = TRUE ;
  else {
  mu__boolexpr58 = ((mu_Cache[mu_j].mu_State) == (mu_S)) ; 
}
...
bool mu__condition_61() // Condition for Rule "CntrlProp, j:1, i:1"
{
  return mu__invariant_53( 1, 1 );
}

bool mu__condition_62() // Condition for Rule "CntrlProp, j:1, i:2"
{
  return mu__invariant_53( 1, 2 );
}

bool mu__condition_63() // Condition for Rule "CntrlProp, j:1, i:3"
{
  return mu__invariant_53( 1, 3 );
}

bool mu__condition_64() // Condition for Rule "CntrlProp, j:1, i:4"
{
  return mu__invariant_53( 1, 4 );
}

bool mu__condition_66() // Condition for Rule "CntrlProp, j:2, i:1"
{
  return mu__invariant_53( 2, 1 );
}

bool mu__condition_67() // Condition for Rule "CntrlProp, j:2, i:2"
{
  return mu__invariant_53( 2, 2 );
}

bool mu__condition_68() // Condition for Rule "CntrlProp, j:2, i:3"
{
  return mu__invariant_53( 2, 3 );
}

bool mu__condition_69() // Condition for Rule "CntrlProp, j:2, i:4"
{
  return mu__invariant_53( 2, 4 );
}

bool mu__condition_71() // Condition for Rule "CntrlProp, j:3, i:1"
{
  return mu__invariant_53( 3, 1 );
}

bool mu__condition_72() // Condition for Rule "CntrlProp, j:3, i:2"
{
  return mu__invariant_53( 3, 2 );
}

bool mu__condition_73() // Condition for Rule "CntrlProp, j:3, i:3"
{
  return mu__invariant_53( 3, 3 );
}

bool mu__condition_74() // Condition for Rule "CntrlProp, j:3, i:4"
{
  return mu__invariant_53( 3, 4 );
}

bool mu__condition_76() // Condition for Rule "CntrlProp, j:4, i:1"
{
  return mu__invariant_53( 4, 1 );
}

bool mu__condition_77() // Condition for Rule "CntrlProp, j:4, i:2"
{
  return mu__invariant_53( 4, 2 );
}

bool mu__condition_78() // Condition for Rule "CntrlProp, j:4, i:3"
{
  return mu__invariant_53( 4, 3 );
}

bool mu__condition_79() // Condition for Rule "CntrlProp, j:4, i:4"
{
  return mu__invariant_53( 4, 4 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"CntrlProp, j:4, i:4", &mu__condition_79, NULL, },
{"CntrlProp, j:4, i:3", &mu__condition_78, NULL, },
{"CntrlProp, j:4, i:2", &mu__condition_77, NULL, },
{"CntrlProp, j:4, i:1", &mu__condition_76, NULL, },
{"CntrlProp, j:3, i:4", &mu__condition_74, NULL, },
{"CntrlProp, j:3, i:3", &mu__condition_73, NULL, },
{"CntrlProp, j:3, i:2", &mu__condition_72, NULL, },
{"CntrlProp, j:3, i:1", &mu__condition_71, NULL, },
{"CntrlProp, j:2, i:4", &mu__condition_69, NULL, },
{"CntrlProp, j:2, i:3", &mu__condition_68, NULL, },
{"CntrlProp, j:2, i:2", &mu__condition_67, NULL, },
{"CntrlProp, j:2, i:1", &mu__condition_66, NULL, },
{"CntrlProp, j:1, i:4", &mu__condition_64, NULL, },
{"CntrlProp, j:1, i:3", &mu__condition_63, NULL, },
{"CntrlProp, j:1, i:2", &mu__condition_62, NULL, },
{"CntrlProp, j:1, i:1", &mu__condition_61, NULL, },
{"DataProp, i:4", &mu__condition_52, NULL, },
{"DataProp, i:3", &mu__condition_51, NULL, },
{"DataProp, i:2", &mu__condition_50, NULL, },
{"DataProp, i:1", &mu__condition_49, NULL, },
};
const unsigned short numinvariants = 20;
