...
rule "Ln_receive_AcquireBlock_1"
    Tree[j].sons[b2] = i &
...
rule "Ln_receive_AcquireBlock_4"
    Tree[j].sons[b2] = i &
    Tree[i].link[b1][1].opcode = AcquireBlock &
...
rule "Ln_receive_AcquireBlock_5"
    Tree[j].sons[b2] = i &
    Tree[i].link[b1][1].opcode = AcquireBlock &
    Tree[i].link[b1][1].para = NtoT &
    Tree[i].cache.state = Branch &
...
rule "Ln_receive_ReleaseData"
    Tree[i].link[b1][3].opcode = ReleaseData
==>
var msg : msgType;
begin
    --undefine Tree[i].link[b1][3];
