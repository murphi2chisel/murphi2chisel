/******************************
  Program "../src/example/protocol.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "../src/example/protocol"
...
int mu__invariant_51( const mu_1_NODE &mu_j, const mu_1_NODE &mu_i) // Invariant "CntrlProp"
{
bool mu__boolexpr52;
  if (!((mu_i) != (mu_j))) mu__boolexpr52 = TRUE ;
  else {
bool mu__boolexpr53;
bool mu__boolexpr54;
  if (!((mu_Cache[mu_i].mu_State) == (mu_E))) mu__boolexpr54 = TRUE ;
  else {
  mu__boolexpr54 = ((mu_Cache[mu_j].mu_State) == (mu_I)) ; 
}
  if (!(mu__boolexpr54)) mu__boolexpr53 = FALSE ;
  else {
bool mu__boolexpr55;
  if (!((mu_Cache[mu_i].mu_State) == (mu_S))) mu__boolexpr55 = TRUE ;
  else {
bool mu__boolexpr56;
  if ((mu_Cache[mu_j].mu_State) == (mu_I)) mu__boolexpr56 = TRUE ;
  else {
  mu__boolexpr56 = ((mu_Cache[mu_j].mu_State) == (mu_S)) ; 
}
...
bool mu__condition_59() // Condition for Rule "CntrlProp, j:1, i:1"
{
  return mu__invariant_51( 1, 1 );
}

bool mu__condition_60() // Condition for Rule "CntrlProp, j:1, i:2"
{
  return mu__invariant_51( 1, 2 );
}

bool mu__condition_62() // Condition for Rule "CntrlProp, j:2, i:1"
{
  return mu__invariant_51( 2, 1 );
}

bool mu__condition_63() // Condition for Rule "CntrlProp, j:2, i:2"
{
  return mu__invariant_51( 2, 2 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"CntrlProp, j:2, i:2", &mu__condition_63, NULL, },
{"CntrlProp, j:2, i:1", &mu__condition_62, NULL, },
{"CntrlProp, j:1, i:2", &mu__condition_60, NULL, },
{"CntrlProp, j:1, i:1", &mu__condition_59, NULL, },
