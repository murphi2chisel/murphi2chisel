...
invariant "czh"
  !(Cache[1].State=I&Cache[2].State=I&Chan1[1].Cmd=Empty&Chan1[2].Cmd=Empty&Chan2[1].Cmd=Empty&Chan2[2].Cmd=Empty&Chan3[1].Cmd=Empty&Chan3[2].Cmd=Empty&InvSet[1]=false&InvSet[2]=false&ShrSet[1]=false&ShrSet[2]=false&ExGntd=true&CurCmd=Empty);